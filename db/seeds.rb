...
HappyHour = Event.create!({title: 'GA Happy Hour', code: '12orbust', location: 'GA Student Area', time: '6:00', cost: '0.00', date: '11/4/2016'})
...
Liza.attendances.create!(event:HappyHour)
...
Andres.attendances.create!(event:HappyHour)
...
Latoya.attendances.create!(event:HappyHour)
...
Mike.attendances.create!(event:HappyHour)
...
Kevin.attendances.create!(event:HappyHour)
...
Andy.attendances.create!(event:HappyHour)
...
Michael.attendances.create!(event:HappyHour)
...
Adrian.attendances.create!(event:HappyHour)
...
Jesse.attendances.create!(event:HappyHour)
...
Nick.attendances.create!(event:HappyHour)
